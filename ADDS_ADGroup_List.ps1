## script exports all domain groups to csv.
##
...
Select-Object Name,Description,ManagedBy,mail,whenCreated,distinguishedName |
Export-Csv -Path "$selec_path\$SrceDN-DomainGroups-$Date.csv" –NoTypeInformation
